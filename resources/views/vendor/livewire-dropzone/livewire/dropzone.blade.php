...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-justify-center dark:dz-bg-gray-800 dark:dz-border-gray-600 dark:hover:dz-border-gray-500">
        @if(! is_null($error))
