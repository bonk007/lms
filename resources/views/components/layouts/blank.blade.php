    ...
    <div class="flex flex-col h-screen bg-slate-50 dark:bg-slate-900">
        ...
        <div class="w-full flex items-center gap-4 pr-20">
            ...
            @auth()
                ...
                <a href="{{ route('notifications') }}" class="w-[42px] h-[42px] flex justify-center items-center bg-slate-50 dark:bg-opacity-5 dark:text-slate-50 hover:text-red-500 hover:bg-opacity-10 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
