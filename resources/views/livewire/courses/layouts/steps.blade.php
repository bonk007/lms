<div x-data="{
    ...
    get current() {
        ...
        let current = hash ? this.steps.findIndex((s) => s === hash.substring(1)) : 0
    ...
    get nextHash() {
        ...
        return this.steps[nextIndex] ? `#${this.steps[nextIndex]}` : window.location.hash
    },
    get prevHash() {
        let prevIndex = this.current - 1
        return this.steps[prevIndex] ? `#${this.steps[prevIndex]}` : `#${this.steps[0]}`
    },
    init() {

        let current = this.current

        window.location.hash = this.steps[current]

        $wire.jumpTo(current)
    }
}">
    <div class="h-[360px] flex flex-col items-center justify-center gap-8">
        ...
        <div class="flex justify-center items-center gap-4">
            ...
            <span :class="current < 1 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                </svg>
            </span>

            <a href="#watching" :class="current < 1 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16">
            ...
            <span :class="current < 2 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                </svg>
            </span>

            <a href="#quiz" :class="current < 2 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
                </svg>
            </a>

            <span :class="current < 3 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
                </svg>
            </span>

            <a href="#discussion" :class="current < 3 && 'text-slate-300 dark:text-slate-600'">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-16">
